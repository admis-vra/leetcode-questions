...
**Difficulty:** `Easy`  
**Topics:** Array, Math  
**LeetCode Link:** [Compute Decimal Representation](https://leetcode.com/problems/compute-decimal-representation/)
...
- **Language:** `cpp`
- **Source File:** [Easy-3697-compute-decimal-representation.cpp](./Easy-3697-compute-decimal-representation.cpp)
