...
**LeetCode Link:** [Find the Degree of Each Vertex](https://leetcode.com/problems/find-the-degree-of-each-vertex/)
...
- **Language:** `python3`
- **Source File:** [Easy-3898-find-the-degree-of-each-vertex.py](./Easy-3898-find-the-degree-of-each-vertex.py)
